...
public class FragmentAlimran extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_alimran, container, false);
    }
    ...
    private void additem(){
        try{
            JSONObject jsonObject = new JSONObject(String.valueOf(alimran.sb));
