...
public class FragmentAlfatihah extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ayat_alfatihah = new Surat_alfatihah();
        additem();
    }
    ...
    private void additem(){
        try{
            JSONObject jsonObject = new JSONObject(ayat_alfatihah.Alfatihah);
